...
- Statuses are lasting effects from past events that continue to influence each character until they are removed or disabled. Statuses are just suggestions and previous events, stats take the authority over them.
- Keep your writing consistent with this data: characters must behave according to their current stats, mind state, relationship and active statuses, even when the scene suggests otherwise.
- Do not repeat or quote this data verbatim in your reply. When scene momentum pulls toward something the stats don't support, follow the stats and show the friction and the results.`;
